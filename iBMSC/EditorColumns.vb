...
Partial Public Class MainWindow
    ...
    Public column() As Column = {New Column(0, 50, "Measure", False, True, False, False, 0, 0, &HFF00FFFF, 0, &HFF00FFFF, 0),
                              New Column(50, 60, "SCROLL", True, True, False, False, 99, 0, &HFFFF0000, 0, &HFFFF0000, 0),
                              New Column(110, 60, "BPM", True, True, False, False, 3, 0, &HFFFF0000, 0, &HFFFF0000, 0),
                              New Column(170, 50, "STOP", True, True, False, False, 9, 0, &HFFFF0000, 0, &HFFFF0000, 0),
                              New Column(220, 5, "", False, False, False, False, 0, 0, 0, 0, 0, 0),
                              ...
                              New Column(498, 5, "", False, False, False, False, 0, 0, 0, 0, 0, 0),
                              New Column(503, 42, "D1", True, False, True, True, 21, &HFFB0B0B0, &HFF000000, &HFFC0C0C0, &HFF000000, &H14FFFFFF),
                              New Column(503, 30, "D2", True, False, True, True, 22, &HFF62B0FF, &HFF000000, &HFF6AB0F7, &HFF000000, &H140033FF),
                              New Column(503, 42, "D3", True, False, True, True, 23, &HFFB0B0B0, &HFF000000, &HFFC0C0C0, &HFF000000, &H14FFFFFF),
                              New Column(503, 45, "D4", True, False, True, True, 24, &HFFFFC862, &HFF000000, &HFFF7C66A, &HFF000000, &H16F38B0C),
                              New Column(503, 42, "D5", True, False, True, True, 25, &HFFB0B0B0, &HFF000000, &HFFC0C0C0, &HFF000000, &H14FFFFFF),
                              New Column(503, 30, "D6", True, False, True, True, 28, &HFF62B0FF, &HFF000000, &HFF6AB0F7, &HFF000000, &H140033FF),
                              New Column(503, 42, "D7", True, False, True, True, 29, &HFFB0B0B0, &HFF000000, &HFFC0C0C0, &HFF000000, &H14FFFFFF),
                              New Column(503, 40, "D8", True, False, True, True, 26, &HFF808080, &HFF000000, &HFF909090, &HFF000000, 0),
