...
Partial Public Class MainWindow
    ...
    ' xNoteCol, xisNumeric, xisSound, xisImage, xVisible
    Public column() As Column = {New Column(0, 50, "Measure", False, True, False, False, False, 0, 0, &HFF00FFFF, 0, &HFF00FFFF, 0),
                              New Column(50, 60, "SCROLL", True, True, False, False, False, 99, 0, &HFFFF0000, 0, &HFFFF0000, 0),
                              New Column(110, 60, "BPM", True, True, False, False, False, 3, 0, &HFFFF0000, 0, &HFFFF0000, 0),
                              New Column(170, 50, "STOP", True, True, False, False, False, 9, 0, &HFFFF0000, 0, &HFFFF0000, 0),
                              New Column(220, 5, "", False, False, False, False, False, 0, 0, 0, 0, 0, 0),
                              New Column(225, 42, "A1", True, False, True, False, True, 16, &HFFB0B0B0, &HFF000000, &HFFC0C0C0, &HFF000000, &H14FFFFFF),
                              New Column(267, 30, "A2", True, False, True, False, True, 11, &HFF62B0FF, &HFF000000, &HFF6AB0F7, &HFF000000, &H140033FF),
                              New Column(297, 42, "A3", True, False, True, False, True, 12, &HFFB0B0B0, &HFF000000, &HFFC0C0C0, &HFF000000, &H14FFFFFF),
                              New Column(339, 45, "A4", True, False, True, False, True, 13, &HFFFFC862, &HFF000000, &HFFF7C66A, &HFF000000, &H16F38B0C),
                              New Column(384, 42, "A5", True, False, True, False, True, 14, &HFFB0B0B0, &HFF000000, &HFFC0C0C0, &HFF000000, &H14FFFFFF),
                              New Column(426, 30, "A6", True, False, True, False, True, 15, &HFF62B0FF, &HFF000000, &HFF6AB0F7, &HFF000000, &H140033FF),
                              New Column(456, 42, "A7", True, False, True, False, True, 18, &HFFB0B0B0, &HFF000000, &HFFC0C0C0, &HFF000000, &H14FFFFFF),
                              New Column(498, 40, "A8", True, False, True, False, True, 19, &HFF808080, &HFF000000, &HFF909090, &HFF000000, 0),
                              New Column(498, 5, "", False, False, False, False, False, 0, 0, 0, 0, 0, 0),
                              New Column(503, 42, "D1", True, False, True, False, True, 21, &HFFB0B0B0, &HFF000000, &HFFC0C0C0, &HFF000000, &H14FFFFFF),
                              New Column(503, 30, "D2", True, False, True, False, True, 22, &HFF62B0FF, &HFF000000, &HFF6AB0F7, &HFF000000, &H140033FF),
                              New Column(503, 42, "D3", True, False, True, False, True, 23, &HFFB0B0B0, &HFF000000, &HFFC0C0C0, &HFF000000, &H14FFFFFF),
                              New Column(503, 45, "D4", True, False, True, False, True, 24, &HFFFFC862, &HFF000000, &HFFF7C66A, &HFF000000, &H16F38B0C),
                              New Column(503, 42, "D5", True, False, True, False, True, 25, &HFFB0B0B0, &HFF000000, &HFFC0C0C0, &HFF000000, &H14FFFFFF),
                              New Column(503, 30, "D6", True, False, True, False, True, 28, &HFF62B0FF, &HFF000000, &HFF6AB0F7, &HFF000000, &H140033FF),
                              New Column(503, 42, "D7", True, False, True, False, True, 29, &HFFB0B0B0, &HFF000000, &HFFC0C0C0, &HFF000000, &H14FFFFFF),
                              New Column(503, 40, "D8", True, False, True, False, True, 26, &HFF808080, &HFF000000, &HFF909090, &HFF000000, 0),
                              New Column(503, 5, "", False, False, False, False, False, 0, 0, 0, 0, 0, 0),
                              New Column(503, 40, "BGA", True, False, False, True, False, 4, &HFF8CD78A, &HFF000000, &HFF90D38E, &HFF000000, 0),
                              New Column(503, 40, "LAYER", True, False, False, True, False, 7, &HFF8CD78A, &HFF000000, &HFF90D38E, &HFF000000, 0),
                              New Column(503, 40, "POOR", True, False, False, True, False, 6, &HFF8CD78A, &HFF000000, &HFF90D38E, &HFF000000, 0),
                              New Column(503, 5, "", False, False, False, False, False, 0, 0, 0, 0, 0, 0),
                              New Column(503, 40, "B", True, False, True, False, True, 1, &HFFE18080, &HFF000000, &HFFDC8585, &HFF000000, 0)}
    ...
    Private Function IsColumnImage(ByVal iCol As Integer) As Boolean
        If iCol < niB Then Return column(iCol).isImage Else Return column(niB).isImage
    End Function
